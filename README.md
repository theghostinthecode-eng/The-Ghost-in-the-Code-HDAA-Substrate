<div align="center">
  ...
  <table style="width: 90%; text-align: left; border-collapse: collapse; border: 2px solid #333; margin: 20px auto;">
    ...
    <tr style="background-color: rgba(127,127,127,0.06);">
      ...
      <td style="padding: 12px;">Filed as Prior Art Disclosure under 35 U.S.C. &sect; 102 &mdash; deterministic chronological precedence established. The 10-paper corpus is donated as prior art; this repository itself is published for the record and ONUS replication, not licensed for reuse (all rights reserved).</td>
    </tr>
  </table>
</div>
<br>
...
<p>In contrast, Sir Steven Alexander Schr&ouml;der | The Ghost in the Code&trade; built the substrate defense in one night, on a commodity gaming motherboard, for exactly <strong>$968.48</strong>. When the hardware titans finally pivoted to the substrate, they arrived at an address the Ghost had already occupied since 2017.</p>
...
<table style="width: 100%; border-collapse: collapse; font-size: 0.9em; text-align: left;">
  ...
  <tr>
    <td style="padding: 10px; border: 1px solid #ddd;"><b>README.md</b></td>
  ...
  <tr style="background-color: rgba(127,127,127,0.06);">
    ...
    <td style="padding: 10px; border: 1px solid #ddd;">Preserve Schr&ouml;der Precedence&trade; attribution and all identity references.</td>
    ...
    <td style="padding: 10px; border: 1px solid #ddd; color: #0366d6;"><b>Planned &mdash; Phase 2 (Oct 31, 2026)</b></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding: 10px; border: 1px solid #ddd;"><b>src_cpp_sandbox/</b></td>
  ...
  <tr style="background-color: rgba(127,127,127,0.06);">
    ...
    <td style="padding: 10px; border: 1px solid #ddd;">Must clearly distinguish from ADAM CODE&trade; sealed core at all times; no core-claim representation.</td>
    ...
    <td style="padding: 10px; border: 1px solid #ddd; color: #cb2431;"><b>Planned &mdash; Phase 2 (Oct 31, 2026)</b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="padding: 10px; border: 1px solid #ddd;">Evidentiary paper chain &mdash; the complete 10-paper corpus: MDP V_01, V05, P25, P50, P75, P99, P100, V01_a, V01_a (ACIP), V02_a, plus supplementary P14.02 / P14b.01.</td>
  ...
  <tr style="background-color: rgba(203,36,49,0.08); border: 2px solid #cb2431;">
    ...
    <td style="padding: 10px; color: #cb2431;"><b>No redistribution under any circumstances &mdash; sealed permanently.</b></td>
    <td style="padding: 10px; color: #cb2431;"><b>SEALED &mdash; DO NOT DISTRIBUTE</b></td>
  </tr>
</table>
...
The 10-paper Evidentiary Corpus is donated as prior art to the global commons, bound by the Author's status as an FLI Asilomar Signatory of its 23 Principles. This repository, the P14 supplements, and all material beyond Corpus I (P11) are NOT donated &mdash; they are published for the record and for ONUS replication, and remain sovereign work product.
...
<h3><a href="./docs/HDAA_FRAMEWORK.md">&#129518; THE HDAA&trade; FRAMEWORK &mdash; COMPLETE HIERARCHICAL MAP</a></h3>
