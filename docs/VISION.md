...
On September 11, 2001, the United States discovered that 19 men with box cutters could shatter the illusion of invulnerability that had made it the most powerful nation on Earth. The Commission that investigated the catastrophe identified its root cause in a single phrase: a failure of imagination.

In 2026, the digital equivalent of that failure of imagination is unfolding in slow motion. The Twin Towers of the digital age are RSA and ECDSA. The adversary boarded in 2015, when encrypted data began to be harvested for future decryption. The plane is called Harvest Now, Decrypt Later. The destination is Q-Day.
...
Software-defined security layers operating at CPU privilege Rings 0 through 3 are fundamentally and permanently vulnerable to logical exploitation, runtime state manipulation, and advanced cryptographic disruption. As compute costs approach zero, software-layer defenses become temporally obsolete.
