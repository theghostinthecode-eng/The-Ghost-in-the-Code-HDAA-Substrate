...
The Part II documentation should explicitly model these threat elements:

- **Actors:** Nation-state adversaries, insider operators, autonomous AI agents, supply-chain infiltrators, and opportunistic OEM actors.
- **Assets:** Kernel trust boundaries, SMM/SMRAM access, release chronology, DOI-deposited publications, and repository provenance.
- **Attack Surfaces:** Rings 0–3 software layers, firmware update paths, hypervisor interfaces, CI/CD provenance, and documentation tampering.
- **Threat Types:** Spoofing, tampering, repudiation, information disclosure, denial of service, escalation of privilege, and chronology inversion.
- **Trust Boundaries:** OS to firmware, firmware to SMM, documentation to publication record, and release artifact to Zenodo DOI.
- **Failure Modes:** Missing timestamps, broken artifact linkage, inconsistent corpus references, overwritten part structure, and ambiguous versioning.
- **Mitigations:** Signed releases, immutable DOI deposits, workflow artifact retention, strict section indexing, and corpus cross-references.
- **Impact Criteria:** Priority loss, publication ambiguity, reproducibility failure, and weakened statutory record.
